...
class _StripePaymentScreenState extends State<StripePaymentScreen> {
  final String postCreateIntentURL = "$rootUrl/api/stripe-order-verify";
  ...
  Widget build(BuildContext context) {
    ...
    final darkModeTextStyle = TextStyle(color: Colors.white);
    final lightModeTextStyle = CardCvcFormField.defaultTextStyle;
            ...
            child: ListView(
              ...
              children: [
                ...
                CardForm(
                  ...
                  cardCvcTextStyle:
                      isDarkMode ? darkModeTextStyle : lightModeTextStyle,
                  cardExpiryTextStyle:
                      isDarkMode ? darkModeTextStyle : lightModeTextStyle,
                  cardNumberTextStyle:
                      isDarkMode ? darkModeTextStyle : lightModeTextStyle,
  ...
  void buy(context) async {
    ...
    print("object ::: $paymentIntentRes");
    String clientSecret = paymentIntentRes['client_secret'];
    print("Payment ID ::: ${paymentIntentRes['id']}");
  ...
  Future<String?> postCreatePaymentIntent(
    ...
    // // final url = Uri.parse(postCreateIntentURL + "?amount=$amount&payment_method_id=$paymentMethodId&email=$email");
    ...
    var headers = {
      ...
      'Authorization':
          'Bearer sk_test_51Ok2uhHu6txA5QVJz3ukK9u6PsOJjZibKVfW33XoSfY10Hw8em5WwHYaO6phiJsHRoX0sBFsM5egDNddwClhfwEN00doiImbEE'
    };
    ...
    final stripeIntentResponse = stripeIntentResponseFromJson(responseBody);
...
class StripeIntentResponse {
  ...
  factory StripeIntentResponse.fromJson(Map<String, dynamic> json) =>
      StripeIntentResponse(
        paymentIntent: PaymentIntent.fromJson(json),
      );
