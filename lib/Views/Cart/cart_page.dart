                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: cartController
                                                ...
                                                : OctoImage(
                                                    image: NetworkImage(
                                                        "${cartController.cartList[index].course?.image}"),
                                                    // placeholderBuilder:
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  courseTitle(cartController
                                                          ...
                                                          .course
                                                          ?.title ??
                                                      "${cartController.cartList[index].course?.title}"),
                                                  courseTPublisher(
                                                      cartController
                                                              .cartList[index]
                                                              .course
                                          ...
                                          children: [
                                            Expanded(
                                              child: cartTitle(cartController
                                                      ...
                                                      .course
                                                      ?.title ??
                                                  "${cartController.cartList[position].course?.title}"),
                                            ),
                                            cartMoney(appCurrency +
                                                cartController
