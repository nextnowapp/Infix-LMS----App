class PayTMResponseModel {
  ...
  PayTMResponseModel({this.success, this.paytm, this.message});

  PayTMResponseModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    paytm = json['paytm'] != null ? new Paytm.fromJson(json['paytm']) : null;
