...
import 'package:lms_flutter_app/Views/Home/Class/class_details_page/class_details_page.dart';
                  ...
                  Container(
                      ...
                      child: Obx(() {
                        if (controller.isLoading.value)
                          ...
                          return Container(
                            height: 80,
                            child: controller.popularCourseList.length == 0
                                ? Center(
                                    child: Text(
                        ...
                        return Container(
                          ...
                          child: controller.popularCourseList.length == 0
                              ...
                              : ListView.separated(
                                  scrollDirection: Axis.horizontal,
                                  itemCount:
                                      controller.popularCourseList.length,
                                  separatorBuilder: (context, index) {
                                    return SizedBox(
                                      width: 18,
                                    );
                                  ...
                                  itemBuilder:
                                    ...
                                    return SingleItemCardWidget(
                                      showPricing: true,
                                      image:
                                          "${controller.popularCourseList[index].image}",
                                      title: controller
                                      ...
                                      onTap: () async {
                                        ...
                                        controller.courseID.value = controller
                  ...
                  Container(
                    ...
                    child: Obx(() {
                      if (controller.isLoading.value)
                        ...
                        return Container(
                          height: 200,
                          child: controller.allClassesList.length == 0
                              ? Center(
                                  child: Text(
                                  'No class available',
                                  style: TextStyle(color: Colors.black),
                              ...
                              : ListView.separated(
                                  ...
                                  itemBuilder:
                                    ...
                                    return SingleItemCardWidget(
                                      showPricing: true,
                                      image:
                                          "${controller.allClassesList[index].image}",
                                      title: controller
                                          .allClassesList[index].title,
                                      subTitle: controller.allClassesList[index]
                                          .assignedInstructor,
                                      price: controller
                                          .allClassesList[index].price,
                                      discountPrice: controller
                  ...
                  Container(
                    ...
                    child: Obx(() {
                      if (controller.isLoading.value)
                        ...
                        return Container(
                          height: 200,
                          child: controller.allQuizzesList.length == 0
                              ? Center(
                                  child: Text(
                                  'No quiz available',
                                  style: TextStyle(color: Colors.black),
                              ...
                              : ListView.separated(
                                  ...
                                  itemBuilder:
                                    ...
                                    return SingleItemCardWidget(
                                      showPricing: true,
                                      image:
                                          "${controller.allQuizzesList[index].image}",
                                      title: controller
                                          .allQuizzesList[index].title,
                                      subTitle: controller.allQuizzesList[index]
                                          .assignedInstructor,
                                      price: controller
                                          .allQuizzesList[index].price,
                                      discountPrice: controller
                  ...
                  Container(
                    ...
                    child: Obx(() {
                      if (controller.isLoading.value)
                        ...
                        return controller.popularCourseList.length == 0
                            ? Center(
                                child: Text(
                                'No course available',
                                style: TextStyle(color: Colors.black),
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return GestureDetector(
                                    child: Container(
                                      ...
                                      margin:
                                          EdgeInsets.fromLTRB(0, 5.8, 0, 5.8),
                                      child: Row(
                                        children: [
                                          ClipRRect(
