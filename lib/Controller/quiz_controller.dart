...
class QuizController extends GetxController {
  ...
  Future fetchAllMyQuiz() async {
    ...
    try {
      ...
      // Fetch quizzes from remote service
      var fetchedQuizzes = await RemoteServices.fetchAllMyQuizzes(token);

      // Ensure fetchedQuizzes is of type List<QuizMain>
