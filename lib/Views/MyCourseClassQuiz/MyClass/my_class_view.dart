...
import 'my_class_detail_page/my_class_details_page.dart';
                        ...
                        if (myClassController.isLoading.value)
                          ...
                          if (myClassController.allMyClass.length == 0) {
                            return Container(
                              child: Center(
                                  child: Texth1(
                                      "${stctrl.lang["No Class found"] ?? "No Class found"}")),
                            );
                          }
                            ...
                            return GridView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return SingleItemCardWidget(
                                    showPricing: false,
                                    image:
                                        '${myClassController.allMyClass[index].image}',
                                    title: myClassController
                                            .allMyClass[index].title ??
                                        "",
                              ...
                              : GridView.builder(
                                  ...
                                  itemBuilder:
                                    ...
                                    return SingleItemCardWidget(
                                      showPricing: false,
                                      image:
                                          "${courseAndClassTabController.allMyClassSearch[index].image}",
                                      title: courseAndClassTabController
                                          .allMyClassSearch[index].title,
