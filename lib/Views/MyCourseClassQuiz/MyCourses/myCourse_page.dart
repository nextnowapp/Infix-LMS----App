                      ...
                      if (myCoursesController.isLoading.value) {
                        ...
                        if (myCoursesController.myCourses.length == 0) {
                          return Center(
                            child: Container(
                              child: Texth1(
                                  "${stctrl.lang["No Course found"] ?? "No Course found"}"),
                            ),
                          );
                        }
                                        ...
                                        Expanded(
                                          child: ClipRRect(
                                            ...
                                            child: Container(
                                              ...
                                              child: OctoImage(
                                                image: NetworkImage(
                                                    "${myCoursesController.myCourses[index].image}"),
                                                // placeholderBuilder:
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: Container(
                                                ...
                                                child: OctoImage(
                                                  image: NetworkImage(
                                                      "${courseAndClassTabController.myCoursesSearch[index].image}"),
                                                  // placeholderBuilder:
                                                  //     OctoPlaceholder.blurHash(
                                                  //   'LEHV6nWB2yk8pyo0adR*.7kCMdnj',
                                                  // ),
