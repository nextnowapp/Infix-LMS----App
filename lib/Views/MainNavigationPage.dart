...
//
//   List<PersistentTabConfig> items() {
//     if (Platform.isIOS) {
//       return [
//         PersistentTabConfig(
//           screen: HomePage(),
...
//             activeForegroundColor: AppStyles.bottomNavigationActiveColor,
//             inactiveForegroundColor: AppStyles.bottomNavigationInActiveColor,
//           ),
//         ),
//         PersistentTabConfig(
//           screen: stctrl.dashboardController.loggedIn.value ? CourseAndClass() : SignInPage(),
//           item: ItemConfig(
//             inactiveIcon: SvgPicture.asset(
...
//         ),
//         PersistentTabConfig(
//           screen: stctrl.dashboardController.loggedIn.value ? HomePage() : SignInPage(),
//           item: ItemConfig(
//               inactiveIcon: SvgPicture.asset(
...
//       ),
//       PersistentTabConfig(
//         screen: stctrl.dashboardController.loggedIn.value ? CartPage() : SignInPage(),
//         item: ItemConfig(
//           inactiveIcon: SvgPicture.asset(
//             "images/icon_cart_inactive.svg",
//             color: AppStyles.bottomNavigationInActiveColor,
...
//       ),
//       PersistentTabConfig(
//         screen: stctrl.dashboardController.loggedIn.value ? CustomDrawer() : SignInPage(),
//         item: ItemConfig(
//           inactiveIcon: SvgPicture.asset(
//                 "images/icon_account_inactive.svg",
//                 color: AppStyles.bottomNavigationInActiveColor,
...
//                 // context,
//                 controller: stctrl.dashboardController.persistentTabController,
