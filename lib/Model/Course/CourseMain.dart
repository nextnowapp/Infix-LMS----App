...
class CourseMain {
  ...
  factory CourseMain.fromJson(Map<String, dynamic> json) => CourseMain(
        ...
        requirements: json['requirements'] == null ? "" : json['requirements'],
        outcomes: json['outcomes'] == null ? "" : json['outcomes'],
        ...
        user: json["instructors"] == null
            ? null
            : User.fromJson(json["instructors"]),
